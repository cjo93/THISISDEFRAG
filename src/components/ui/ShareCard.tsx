    ...
    return (
        <div className="w-full max-w-sm mx-auto group perspective-1000">
            ...
            >
                ...
                <div className="absolute top-0 right-0 w-64 h-64 bg-slate-500/10 rounded-full blur-[80px]" />
                ...
                <div className="relative z-10 p-8 flex flex-col items-center text-center">
                    ...
                    <div className="relative w-16 h-16 flex items-center justify-center mb-6">
                        <svg viewBox="0 0 100 100" className="w-full h-full text-slate-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.4)]" fill="none" stroke="currentColor" strokeWidth="1.2">
                    ...
                    <div className="space-y-4">
                        <div>
                            <div className="text-[10px] tracking-[0.2em] text-slate-400 uppercase mb-1">ARCHETYPE</div>
            ...
            <div className="mt-6 flex justify-center">
                <button
                    onClick={handleShare}
                    className="flex items-center gap-2 px-6 py-3 bg-white text-black text-xs font-bold tracking-[0.1em] rounded-full hover:bg-slate-500 hover:text-white transition-all shadow-lg active:scale-95"
                >
