        ...
        <div className="min-h-screen bg-black text-white selection:bg-white/30">
            ...
            <section className="pt-32 pb-20 px-6 sm:px-12 border-b border-white/5 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900/10 via-black to-black">
                <div className="max-w-7xl mx-auto text-center">
                    <span className="inline-block text-xs font-mono tracking-widest text-gray-300 mb-6 border border-white/30 px-3 py-1 rounded bg-slate-900/10 uppercase">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link to="/docs" className="inline-flex h-14 px-8 items-center justify-center border border-white/20 text-white text-sm tracking-[0.2em] font-medium hover:bg-gray-100 hover:text-black transition-all rounded-lg uppercase">
                            Read Docs
                        </Link>
                    </div>
                </div>
