...
const PlatformHub: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[var(--color-black)] text-[var(--color-white)] font-sans selection:bg-white/20 relative">
            ...
            {/* MAIN CONTENT GRID */}
            {/* Added relative z-10 to ensure content sits above the fixed background */}
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-y-0">
                ...
                <section className="col-span-full py-32 bg-[var(--color-black)]/90 backdrop-blur-sm relative border-t border-white/5">
                ...
                {/* PRE-FOOTER */}
                <section className="col-span-full py-40 bg-[var(--color-black)]/90 backdrop-blur-sm border-t border-white/5 relative overflow-hidden">
                ...
                <div className="col-span-full relative z-10 bg-[var(--color-black)]/90 backdrop-blur-sm">
                    <Footer />
                </div>
