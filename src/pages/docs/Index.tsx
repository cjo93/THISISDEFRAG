    ...
    return (
        <div className="min-h-screen bg-black text-white p-8 md:p-20">
            <section className="text-center mb-20 pt-10">
                <div className="inline-flex items-center gap-2 px-3 py-1 border border-slate-500/50 text-slate-400 text-[10px] font-mono tracking-widest uppercase mb-6 rounded bg-slate-500/5">
                    <span className="w-1.5 h-1.5 rounded-full bg-slate-500 animate-pulse" />
                    Developer Resources
                </div>
                <h1 className="text-5xl md:text-7xl font-light mb-6 tracking-tight text-white">
                    Build with <span className="text-slate-400">Cognitive Middleware</span>
                </h1>
                ...
                <div className="max-w-xl mx-auto relative">
                    <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-full px-6 py-4 text-white focus:outline-none focus:border-slate-500/50 transition font-mono text-sm"
                    />
                </div>
            </section>
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                <Link to="/docs/getting-started" className="p-8 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group">
                    <h3 className="text-xl mb-3 group-hover:text-slate-400 transition">Getting Started</h3>
                ...
                <Link to="/docs/api-reference" className="p-8 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group">
                    <h3 className="text-xl mb-3 group-hover:text-slate-400 transition">API Reference</h3>
                ...
                <Link to="/docs/authentication" className="p-8 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group">
                    <h3 className="text-xl mb-3 group-hover:text-slate-400 transition">Authentication</h3>
                ...
                <Link to="/docs/sdks" className="p-8 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group">
                    <h3 className="text-xl mb-3 group-hover:text-slate-400 transition">SDKs</h3>
                ...
                <Link to="/docs/code-examples" className="p-8 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group">
                    <h3 className="text-xl mb-3 group-hover:text-slate-400 transition">Code Examples</h3>
                ...
                <Link to="/docs/faqs" className="p-8 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition group">
                    <h3 className="text-xl mb-3 group-hover:text-slate-400 transition">FAQs</h3>
